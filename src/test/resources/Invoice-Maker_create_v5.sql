...
-- Last modification date: 2021-03-23 07:55:35.713
...
CREATE TABLE User_Roles (
    ...
    UNIQUE INDEX User_Roles_ak_1 (user_name),
...
ALTER TABLE User_Roles ADD CONSTRAINT User_Roles_User FOREIGN KEY User_Roles_User (user_name)
