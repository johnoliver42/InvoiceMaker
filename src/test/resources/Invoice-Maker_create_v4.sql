...
-- Last modification date: 2021-03-23 06:44:09.344
...
-- Reference: Users_User_Roles (table: User_Roles)
ALTER TABLE User_Roles ADD CONSTRAINT Users_User_Roles FOREIGN KEY Users_User_Roles (user_id)
    REFERENCES User (id);
